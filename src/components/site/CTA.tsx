...
//         >
//           {/* Background effects */}
//           <div className="pointer-events-none absolute -top-16 -right-16 h-72 w-72 rounded-full blur-3xl bg-yellow-400/10" />
...
//                 className="inline-flex h-11 items-center justify-center gap-2 rounded-md px-6 text-sm font-semibold bg-white text-black hover:bg-yellow-300 transition-all"
//               >
//                 Start a Project
...
//               <a
//                 href="#academy"
//                 className="inline-flex h-11 items-center justify-center rounded-md border px-6 text-sm border-white/20 text-white/80 hover:border-yellow-400 hover:text-white"
//               >
//                 Join Training
//               </a>
//             </div>
...
//             <p className="text-sm text-white/60 mt-2">We’ll get back to you within 24 hours.</p>
//             <button
//               onClick={onClose}
//               className="mt-4 bg-white text-black px-4 py-2 rounded-md hover:bg-yellow-300"
//             >
//               Close
//             </button>
//           </div>
...
//               type="submit"
//               disabled={loading}
//               className="mt-2 h-11 rounded-md bg-white text-black font-medium hover:bg-yellow-300 transition-all disabled:opacity-60"
//             >
...
//       required
//       className="h-11 rounded-md border border-white/10 bg-[#0f1112] px-3 text-sm text-white placeholder:text-white/40 focus:border-yellow-400 focus:outline-none"
//     />
//   );
// }
...
//       rows={4}
//       required
//       className="rounded-md border border-white/10 bg-[#0f1112] px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-yellow-400 focus:outline-none"
//     />
//   );
// }
